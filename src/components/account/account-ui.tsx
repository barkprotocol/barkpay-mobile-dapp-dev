...
export function AccountBalance({ address }: { address: PublicKey }) {
  const { barkPayAppPDA } = UsebarkPayAppProgram(address);

  const query = useGetBalance(barkPayAppPDA);
  const theme = {
    ...MD3DarkTheme,
    ...DarkTheme,
    colors: {
...
export function AccountButtonGroup({ address }: { address: PublicKey }) {
  ...
  const { barkPayAppProgram, barkPayAppPDA } = UsebarkPayAppProgram(address);
          ...
          <Button
            ...
            onPress={async () => {
              ...
              try {
                ...
                const deposit = await transferFunds(barkPayAppProgram);
          ...
          <Button
            ...
            onPress={async () => {
              ...
              try {
                ...
                const deposit = await withdrawFunds(barkPayAppProgram);
